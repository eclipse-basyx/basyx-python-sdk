...
if storage_type == "LOCAL_FILE_BACKEND":
    application = RegistryAPI(LocalFileObjectStore(storage_path), aasx.DictSupplementaryFileContainer(), **wsgi_optparams)
    ...
    application = RegistryAPI(object_store, file_store, **wsgi_optparams)
