...
#                                                   within the “selectableSubjectAttributes” attribute of
#                                                   “AccessControl”
#     """
#     def __init__(self,
...
#
#     :ivar selectable_subject_attributes: Reference to a submodel defining the authenticated subjects to access
#                                          elements that are configured for the AAS. They are selectable by the access
#                                          permission rules to assign permissions to the subjects.
...
#     :ivar access_permission_rule: Unordered list of instances of the class AccessPermissionRule Access permission
#                                   rules of the AAS describing the rights assigned to (already authenticated) subjects
#                                   to access elements of the AAS
#
#   TODO: Add instruction what to do after construction
#     """
#
...
#                                           TODO: Default: refer to submodel of default_subject_attributes
#         :param default_subject_attributes: Reference to a submodel defining the default subjects attributes for the
...
#                                                   accessed via the permission rules defined for the AAS, i.e.
#                                                   attributes that are not describing the asset itself.
#                                                   TODO: Default refer to default_environment_attributes
...
#                           Constraint AASd-009: Either there is an external policy administration point endpoint
#                                                defined or the AAS has its own access control.
...
#     """
#     Computes access decisions by evaluating the applicable Digital Policies and Meta-Policies. One of the main
#     functions of the PDP is to mediate or de-conflict Digital Policies according to Meta-Policies
