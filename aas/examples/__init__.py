"""
This package contains examples for the creation of different kind of PyAAS-objects.

example_create_ass.py
...
example_create_aas_mandatory_attributes.py
...
example_create_submodel_template.py
