...
class AbstractIdentifierGenerator(metaclass=abc.ABCMeta):
    """
    Abstract base class for identifier generators that generate :class:`Identifiers <basyx.aas.model.base.Identifier>` based
...
class NamespaceIRIGenerator(AbstractIdentifierGenerator):
    ...
    :class:`Identifiers <basyx.aas.model.base.Identifier>` are generated by concatenating a fixed namespace with the proposed
