...
"""
Tests for the example aas missing attributes

Functions to test if an object is the same to the example aas missing attributes from example_aas_missing_attributes.py
"""
...
from aas.examples.data import example_aas_missing_attributes


def assert_example_asset(checker: AASDataChecker, asset: model.Asset) -> None:
    expected_asset = example_aas_missing_attributes.create_example_asset()
...
def assert_example_concept_description(checker: AASDataChecker, concept_description: model.ConceptDescription) -> None:
    expected_concept_description = example_aas_missing_attributes.create_example_concept_description()
...
def assert_example_asset_administration_shell(checker: AASDataChecker, shell: model.AssetAdministrationShell) -> None:
    example_cd = example_aas_missing_attributes.create_example_concept_dictionary()
    expected_shell = example_aas_missing_attributes.create_example_asset_administration_shell(example_cd)
...
def assert_example_submodel(checker: AASDataChecker, submodel: model.Submodel) -> None:
    expected_submodel = example_aas_missing_attributes.create_example_submodel()
