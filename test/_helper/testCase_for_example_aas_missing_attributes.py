...
def assert_example_asset(self, asset: model.Asset) -> None:
    ...
    self.assertEqual('https://acplt.org/Test_Asset_Missing', asset.identification.id)
...
def assert_example_concept_description(self, concept_description: model.ConceptDescription) -> None:
    ...
    self.assertEqual('https://acplt.org/Test_ConceptDescription_Missing', concept_description.identification.id)
...
def assert_example_asset_administration_shell(self, shell: model.AssetAdministrationShell) -> None:
    ...
    self.assertEqual(shell.asset, model.AASReference((
        ...
        model.Asset))
    self.assertEqual('https://acplt.org/Test_AssetAdministrationShell_Missing', shell.identification.id)
...
def assert_example_submodel(self, submodel: model.Submodel) -> None:
    ...
    self.assertEqual('https://acplt.org/Test_Submodel_Missing', submodel.identification.id)
