...
def find_Reference_in_set(reference: model.Reference, set_to_search: Set) -> bool:
    for reference_to_find in set_to_search:
        if reference_to_find.__eq__(reference) is True:
            return True
    else:
        return False
...
class ExampleHelper(unittest.TestCase):
    def assert_example_asset_identification_submodel(self, submodel: model.Submodel) -> None:
        ...
        self.assertEqual(1, submodel.data_specification.__len__())
        ...
        self.assertEqual(True, submodel.semantic_id.__eq__(model.Reference((
        ...
        self.assertEqual(True, manufacturer_name.value_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
        ...
        self.assertEqual(True, manufacturer_name.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
        ...
        for qualifier in manufacturer_name.qualifier:  # type: ignore
            ...
            self.assertEqual(True, qualifier.value_id.__eq__(model.Reference((
                model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                          local=False,
                          value='http://acplt.org/ValueId/ExampleValueId',
                          id_type=model.KeyType.IRDI),))))
        ...
        for formula in instance_id.qualifier:  # type: ignore
            ...
            for reference in formula.depends_on:
                self.assertEqual(True, reference.__eq__(model.Reference((
                    model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                              local=False,
    ...
    def assert_example_bill_of_material_submodel(self, submodel: model.Submodel) -> None:
        ...
        self.assertEqual(1, example_entity.statement.__len__())
        ...
        self.assertEqual(0, example_entity.data_specification.__len__())
        self.assertEqual(True, example_entity.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://opcfoundation.org/UA/DI/1.1/DeviceType/Serialnumber',
                      id_type=model.KeyType.IRI),))))
        self.assertEqual(0, example_entity.qualifier.__len__())
        ...
        self.assertEqual(True, example_property.value_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/ValueId/ExampleValueId',
                      id_type=model.KeyType.IRDI),))))
        ...
        self.assertEqual(0, example_property.data_specification.__len__())
        self.assertEqual(True, example_property.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/Properties/ExampleProperty',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, example_property.qualifier.__len__())
        ...
        self.assertEqual(0, example_entity2.statement.__len__())
        self.assertEqual(True, example_entity2.asset.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.ASSET,
                      local=False,
        ...
        self.assertEqual(0, example_entity2.data_specification.__len__())
        self.assertEqual(True, example_entity2.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://opcfoundation.org/UA/DI/1.1/DeviceType/Serialnumber',
                      id_type=model.KeyType.IRI),))))
        self.assertEqual(0, example_entity2.qualifier.__len__())
    ...
    def assert_example_asset(self, asset: model.Asset) -> None:
        ...
        self.assertEqual(1, asset.data_specification.__len__())
        self.assertEqual(True, find_Reference_in_set(model.Reference((
                    model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                              local=False,
                              value='http://acplt.org/DataSpecifications/AssetTypes/TestAsset',
                              id_type=model.KeyType.IRDI),)), asset.data_specification))
        self.assertEqual(True, asset.asset_identification_model.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.SUBMODEL,
                      local=False,
                      value='http://acplt.org/Submodels/Assets/TestAsset/Identification',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(True, asset.bill_of_material.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.SUBMODEL,
                      local=False,
    ...
    def assert_example_concept_description(self, concept_description: model.ConceptDescription) -> None:
        ...
        self.assertEqual(1, concept_description.is_case_of.__len__())
        self.assertEqual(True, find_Reference_in_set(model.Reference((
                    model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                              local=False,
        ...
        self.assertEqual(1, concept_description.data_specification.__len__())
        self.assertEqual(True, find_Reference_in_set(model.Reference((
                    model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                              local=False,
                              value='http://acplt.org/DataSpecifications/ConceptDescriptions/TestConceptDescription',
    ...
    def assert_example_asset_administration_shell(self, shell: model.AssetAdministrationShell) -> None:
        ...
        self.assertEqual(True, shell.asset.__eq__(model.AASReference((
            model.Key(type_=model.KeyElements.ASSET,
                      local=False,
        ...
        self.assertEqual(0, shell.data_specification.__len__())
        self.assertIsNone(shell.security_)
        self.assertEqual(1, shell.submodel_.__len__())
        self.assertEqual(True, find_Reference_in_set(model.AASReference((
            model.Key(type_=model.KeyElements.SUBMODEL,
                      local=False,
            ...
            model.Submodel),
            shell.submodel_))
        self.assertEqual(1, shell.concept_dictionary.__len__())
        ...
        self.assertEqual(0, shell.view.__len__())
        self.assertEqual(True, shell.derived_from.__eq__(model.AASReference((
    ...
    def assert_example_submodel(self, submodel: model.Submodel) -> None:
        ...
        self.assertEqual(model.IdentifierType.IRI, submodel.identification.id_type)
        self.assertEqual(7, submodel.submodel_element.__len__())
        ...
        self.assertEqual(True, rel_element.first.__eq__(model.AASReference((
            model.Key(type_=model.KeyElements.PROPERTY,
                      local=True,
                      value='ExampleProperty',
                      id_type=model.KeyType.IDSHORT),),
            model.Property)))
        self.assertEqual(True, rel_element.second.__eq__(model.AASReference((
            model.Key(type_=model.KeyElements.PROPERTY,
                      local=True,
                      value='ExampleProperty',
                      id_type=model.KeyType.IDSHORT),),
        ...
        self.assertEqual(0, rel_element.data_specification.__len__())
        self.assertEqual(True, rel_element.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/RelationshipElements/ExampleRelationshipElement',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, rel_element.qualifier.__len__())
        ...
        self.assertEqual(True, rel_element_annotated.first.__eq__(model.AASReference((
            model.Key(type_=model.KeyElements.PROPERTY,
                      local=True,
                      value='ExampleProperty',
                      id_type=model.KeyType.IDSHORT),),
            model.Property)))
        self.assertEqual(True, rel_element_annotated.second.__eq__(model.AASReference((
            model.Key(type_=model.KeyElements.PROPERTY,
                      local=True,
                      value='ExampleProperty',
                      id_type=model.KeyType.IDSHORT),),
        ...
        self.assertEqual(0, rel_element_annotated.data_specification.__len__())
        self.assertEqual(True, rel_element_annotated.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/RelationshipElements/ExampleAnnotatedRelationshipElement',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, rel_element_annotated.qualifier.__len__())
        ...
        self.assertEqual(1, operation_element.input_variable.__len__())
        self.assertEqual(1, operation_element.output_variable.__len__())
        self.assertEqual(1, operation_element.in_output_variable.__len__())
        ...
        self.assertEqual(0, operation_element.data_specification.__len__())
        self.assertEqual(True, operation_element.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/Operations/ExampleOperation',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, operation_element.qualifier.__len__())
        ...
        self.assertEqual(0, capability_element.data_specification.__len__())
        self.assertEqual(True, capability_element.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/Capabilities/ExampleCapability',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, capability_element.qualifier.__len__())
        ...
        self.assertEqual(True, basic_event_element.observed.__eq__(model.AASReference((
            model.Key(type_=model.KeyElements.PROPERTY,
                      local=True,
                      value='ExampleProperty',
                      id_type=model.KeyType.IDSHORT),),
        ...
        self.assertEqual(0, basic_event_element.data_specification.__len__())
        self.assertEqual(True, basic_event_element.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/Events/ExampleBasicEvent',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, basic_event_element.qualifier.__len__())
        ...
        self.assertEqual(3, ordered_collection.value.__len__())
        ...
        self.assertEqual(0, ordered_collection.data_specification.__len__())
        self.assertEqual(True, ordered_collection.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/SubmodelElementCollections/ExampleSubmodelElementCollectionOrdered',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, ordered_collection.qualifier.__len__())
        ...
        self.assertEqual(True, example_ml_property.value_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
        ...
        self.assertEqual(0, example_ml_property.data_specification.__len__())
        self.assertEqual(True, example_ml_property.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/MultiLanguageProperties/ExampleMultiLanguageProperty',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, example_ml_property.qualifier.__len__())
        ...
        self.assertEqual(0, range_element.data_specification.__len__())
        self.assertEqual(True, range_element.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/Ranges/ExampleRange',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, range_element.qualifier.__len__())
        ...
        self.assertEqual(3, unordered_collection.value.__len__())
        ...
        self.assertEqual(0, unordered_collection.data_specification.__len__())
        self.assertEqual(True, unordered_collection.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/SubmodelElementCollections/ExampleSubmodelElementCollectionUnordered',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, unordered_collection.qualifier.__len__())
        ...
        self.assertEqual(0, blob_element.data_specification.__len__())
        self.assertEqual(True, blob_element.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/Blobs/ExampleBlob',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, blob_element.qualifier.__len__())
        ...
        self.assertEqual(0, file_element.data_specification.__len__())
        self.assertEqual(True, file_element.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/Files/ExampleFile',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, file_element.qualifier.__len__())
        ...
        self.assertEqual(True, ref_element.value.__eq__(model.AASReference((
            model.Key(type_=model.KeyElements.PROPERTY,
                      local=True,
                      value='ExampleProperty',
                      id_type=model.KeyType.IDSHORT),),
        ...
        self.assertEqual(0, ref_element.data_specification.__len__())
        self.assertEqual(True, ref_element.semantic_id.__eq__(model.Reference((
            model.Key(type_=model.KeyElements.GLOBAL_REFERENCE,
                      local=False,
                      value='http://acplt.org/ReferenceElements/ExampleReferenceElement',
                      id_type=model.KeyType.IRDI),))))
        self.assertEqual(0, ref_element.qualifier.__len__())
