...
def assert_example_asset(self, asset: model.Asset) -> None:
    ...
    self.assertEqual('https://acplt.org/Test_Asset_Mandatory', asset.identification.id)
...
def assert_example_concept_description(self, concept_description: model.ConceptDescription) -> None:
    ...
    self.assertEqual('https://acplt.org/Test_ConceptDescription_Mandatory', concept_description.identification.id)
...
def assert_example_asset_administration_shell(self, shell: model.AssetAdministrationShell) -> None:
    ...
    self.assertEqual(shell.asset, model.AASReference((
        ...
        model.Asset))
    self.assertEqual('https://acplt.org/Test_AssetAdministrationShell_Mandatory', shell.identification.id)
...
def assert_example_empty_asset_administration_shell(self, shell: model.AssetAdministrationShell) -> None:
    ...
    self.assertEqual(shell.asset, model.AASReference((
        model.Key(type_=model.KeyElements.ASSET,
                  ...
                  id_type=model.KeyType.IRDI),),
        model.Asset))
    self.assertEqual('https://acplt.org/Test_AssetAdministrationShell2_Mandatory', shell.identification.id)
    self.assertEqual(model.IdentifierType.IRI, shell.identification.id_type)
...
def assert_example_submodel(self, submodel: model.Submodel) -> None:
    ...
    self.assertEqual('https://acplt.org/Test_Submodel_Mandatory', submodel.identification.id)
...
def assert_example_empty_submodel(self, submodel: model.Submodel) -> None:
    # Test attributes of Submodel
    self.assertEqual('https://acplt.org/Test_Submodel2_Mandatory', submodel.identification.id)
    self.assertEqual(model.IdentifierType.IRI, submodel.identification.id_type)
...
def assert_full_example(self, obj_store: model.DictObjectStore, failsafe: bool = True) -> None:
    ...
    for shell in shells:
        if shell.identification.id == 'https://acplt.org/Test_AssetAdministrationShell_Mandatory':
            ...
            assert_example_empty_asset_administration_shell(self, shell)
        else:
            if failsafe:
                raise KeyError()
    ...
    for submodel in submodels:
        if submodel.identification.id == 'https://acplt.org/Test_Submodel_Mandatory':
            ...
            assert_example_empty_submodel(self, submodel)
        else:
            if failsafe:
                raise KeyError()
