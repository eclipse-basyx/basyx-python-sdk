...
def abstract_classes_to_xml(tag: str, obj: object) -> etree._Element:
        ...
        if obj.extension:
            ...
            for extension in obj.extension:
                if isinstance(extension, model.Extension):
                    et_extension.append(
                        extension_to_xml(extension, tag=NS_AAS + "extension")
                    )
    ...
    if isinstance(obj, model.Referable):
        ...
        if obj.display_name:
            elm.append(
                lang_string_set_to_xml(obj.display_name, tag=NS_AAS + "displayName")
            )
        if obj.description:
            elm.append(
                lang_string_set_to_xml(obj.description, tag=NS_AAS + "description")
            )
    ...
    if isinstance(obj, model.HasSemantics):
        ...
        if obj.supplemental_semantic_id:
            et_supplemental_semantic_ids = _generate_element(
                NS_AAS + "supplementalSemanticIds"
            )
    ...
    if isinstance(obj, model.Qualifiable):
        if obj.qualifier:
            ...
            for qualifier in obj.qualifier:
                et_qualifier.append(
                    qualifier_to_xml(qualifier, tag=NS_AAS + "qualifier")
                )
    ...
    if isinstance(obj, model.HasDataSpecification):
        if obj.embedded_data_specifications:
            ...
            for eds in obj.embedded_data_specifications:
                et_embedded_data_specifications.append(
                    embedded_data_specification_to_xml(eds)
                )
...
def administrative_information_to_xml(
    ...
    if obj.version:
        et_administration.append(
            _generate_element(name=NS_AAS + "version", text=obj.version)
        )
    if obj.revision:
        et_administration.append(
            _generate_element(name=NS_AAS + "revision", text=obj.revision)
        )
    if obj.creator:
...
def key_to_xml(obj: model.Key, tag: str = NS_AAS + "key") -> etree._Element:
    ...
    et_key.append(
        _generate_element(name=NS_AAS + "type", text=_generic.KEY_TYPES[obj.type])
    )
    et_key.append(_generate_element(name=NS_AAS + "value", text=obj.value))
    return et_key


def reference_to_xml(
    obj: model.Reference, tag: str = NS_AAS + "reference"
) -> etree._Element:
    """
...
def qualifier_to_xml(
    obj: model.Qualifier, tag: str = NS_AAS + "qualifier"
) -> etree._Element:
    """
    ...
    et_qualifier.append(
        _generate_element(NS_AAS + "kind", text=_generic.QUALIFIER_KIND[obj.kind])
    )
...
def extension_to_xml(
    obj: model.Extension, tag: str = NS_AAS + "extension"
) -> etree._Element:
    """
...
def value_list_to_xml(
    obj: model.ValueList, tag: str = NS_AAS + "valueList"
) -> etree._Element:
    """
    ...
    for aas_reference_pair in obj:
        et_value_reference_pairs.append(
            value_reference_pair_to_xml(
                aas_reference_pair, NS_AAS + "valueReferencePair"
            )
        )
...
def specific_asset_id_to_xml(
    ...
    et_asset_information.append(
        _generate_element(name=NS_AAS + "value", text=obj.value)
    )
...
def asset_information_to_xml(
    ...
    et_asset_information.append(
        _generate_element(
            name=NS_AAS + "assetKind", text=_generic.ASSET_KIND[obj.asset_kind]
        )
    )
...
def embedded_data_specification_to_xml(
    obj: model.EmbeddedDataSpecification,
    tag: str = NS_AAS + "embeddedDataSpecification",
) -> etree._Element:
    """
...
def data_specification_iec61360_to_xml(
    obj: model.DataSpecificationIEC61360,
    tag: str = NS_AAS + "dataSpecificationIec61360",
) -> etree._Element:
    """
    ...
    if obj.unit is not None:
        et_data_specification_iec61360.append(
            _generate_element(NS_AAS + "unit", text=obj.unit)
        )
    if obj.unit_id is not None:
        et_data_specification_iec61360.append(
            reference_to_xml(obj.unit_id, NS_AAS + "unitId")
        )
    if obj.source_of_definition is not None:
        et_data_specification_iec61360.append(
            _generate_element(
                NS_AAS + "sourceOfDefinition", text=obj.source_of_definition
            )
        )
    if obj.symbol is not None:
        et_data_specification_iec61360.append(
            _generate_element(NS_AAS + "symbol", text=obj.symbol)
        )
    if obj.data_type is not None:
        et_data_specification_iec61360.append(
            _generate_element(
                NS_AAS + "dataType", text=_generic.IEC61360_DATA_TYPES[obj.data_type]
            )
        )
    ...
    if obj.value is not None:
        et_data_specification_iec61360.append(
            _generate_element(NS_AAS + "value", text=obj.value)
        )
    if obj.level_types:
...
def asset_administration_shell_to_xml(
    ...
    et_aas.append(
        asset_information_to_xml(obj.asset_information, tag=NS_AAS + "assetInformation")
    )
    if obj.submodel:
...
def submodel_to_xml(
    obj: model.Submodel, tag: str = NS_AAS + "submodel"
) -> etree._Element:
    """
...
def property_to_xml(
    obj: model.Property, tag: str = NS_AAS + "property"
) -> etree._Element:
    """
...
def multi_language_property_to_xml(
    ...
    if obj.value:
        et_multi_language_property.append(
            lang_string_set_to_xml(obj.value, tag=NS_AAS + "value")
        )
    if obj.value_id:
        et_multi_language_property.append(
            reference_to_xml(obj.value_id, NS_AAS + "valueId")
        )
...
def resource_to_xml(
    obj: model.Resource, tag: str = NS_AAS + "resource"
) -> etree._Element:
    """
    ...
    if obj.content_type:
        et_resource.append(
            _generate_element(NS_AAS + "contentType", text=obj.content_type)
        )
    return et_resource
...
def submodel_element_collection_to_xml(
    obj: model.SubmodelElementCollection,
    tag: str = NS_AAS + "submodelElementCollection",
) -> etree._Element:
    """
...
def submodel_element_list_to_xml(
    ...
    if obj.semantic_id_list_element is not None:
        et_submodel_element_list.append(
            reference_to_xml(
                obj.semantic_id_list_element, NS_AAS + "semanticIdListElement"
            )
        )
    et_submodel_element_list.append(
        _generate_element(
...
def annotated_relationship_element_to_xml(
    obj: model.AnnotatedRelationshipElement,
    tag: str = NS_AAS + "annotatedRelationshipElement",
) -> etree._Element:
    """
...
def operation_to_xml(
    obj: model.Operation, tag: str = NS_AAS + "operation"
) -> etree._Element:
    """
...
def capability_to_xml(
    obj: model.Capability, tag: str = NS_AAS + "capability"
) -> etree._Element:
    """
...
def entity_to_xml(obj: model.Entity, tag: str = NS_AAS + "entity") -> etree._Element:
    ...
    if obj.entity_type:
        et_entity.append(
            _generate_element(
                NS_AAS + "entityType", text=_generic.ENTITY_TYPES[obj.entity_type]
            )
        )
    if obj.global_asset_id:
        et_entity.append(
            _generate_element(NS_AAS + "globalAssetId", text=obj.global_asset_id)
        )
    if obj.specific_asset_id:
        et_specific_asset_id = _generate_element(name=NS_AAS + "specificAssetIds")
        for specific_asset_id in obj.specific_asset_id:
...
def basic_event_element_to_xml(
    ...
    if obj.last_update is not None:
        et_basic_event_element.append(
            _generate_element(
                NS_AAS + "lastUpdate", text=model.datatypes.xsd_repr(obj.last_update)
            )
        )
...
def _write_element(
    file: _generic.PathOrBinaryIO, element: etree._Element, **kwargs
) -> None:
...
def object_store_to_xml_element(data: model.AbstractObjectStore) -> etree._Element:
    ...
    if asset_administration_shells:
        et_asset_administration_shells = etree.Element(
            NS_AAS + "assetAdministrationShells"
        )
        for aas_obj in asset_administration_shells:
            et_asset_administration_shells.append(
                asset_administration_shell_to_xml(aas_obj)
            )
