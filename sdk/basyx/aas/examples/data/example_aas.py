...
"""
Module for the creation of an :class:`IdentifiableStore <basyx.aas.model.provider.DictIdentifiableStore>` containing an
...
_embedded_data_specification_iec61360 = model.EmbeddedDataSpecification(
    ...
    data_specification_content=model.DataSpecificationIEC61360(
        ...
        short_name=model.ShortNameTypeIEC61360(
        ...
        source_of_definition="http://example.org/DataSpec/ExampleDef",
        symbol="SU",
        value_format="M",
        value_list={
...
def create_example_asset_identification_submodel() -> model.Submodel:
    ...
    identification_submodel_element_manufacturer_name = model.Property(
        ...
        semantic_id=model.ExternalReference(
            (
                model.Key(
                    type_=model.KeyTypes.GLOBAL_REFERENCE, value="0173-1#02-AAO677#002"
                ),
            )
        ),
...
def check_example_concept_description(
    ...
    checker.check_concept_description_equal(
        concept_description, expected_concept_description
    )
