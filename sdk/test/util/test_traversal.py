...
class TestWalkSubmodel(unittest.TestCase):
    ...
    def test_entity_statement_traversal(self):
        ...
        entity = model.Entity(
            "entity", model.EntityType.CO_MANAGED_ENTITY, statement=[stmt]
        )
    ...
    def test_collection_inside_entity_statement(self):
        ...
        entity = model.Entity(
            "entity", model.EntityType.CO_MANAGED_ENTITY, statement=[coll]
        )
        sm = self._submodel(entity)
        result = list(walk_submodel(sm))
    ...
    def test_walk_from_collection(self):
        prop = model.Property("prop", model.datatypes.String)
        entity = model.Entity(
            "entity", model.EntityType.CO_MANAGED_ENTITY, statement=[prop]
        )
    ...
    def test_walk_from_list(self):
        ...
        sml = model.SubmodelElementList(
            "sml", type_value_list_element=model.Operation, value=[op]
        )
    ...
    def test_file_inside_entity_is_found(self):
        ...
        entity = model.Entity(
            "entity", model.EntityType.CO_MANAGED_ENTITY, statement=[f]
        )
        sm = self._submodel(entity)
