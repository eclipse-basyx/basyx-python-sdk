...
class DataCheckerTest(unittest.TestCase):
    ...
    def test_kwargs(self):
        ...
        self.assertEqual(
            "('Check failed: Assertion test 1', {'value': 'kwargs1'})",
            str(cm.exception),
        )
        self.assertEqual(
            "('Check failed: Assertion test 2', {'value': 'kwargs2'})",
            str(cm_2.exception),
        )
    ...
    def test_raise_failed(self):
        ...
        self.assertEqual(
            "('1 of 2 checks failed', ['Assertion test'])", str(cm.exception)
        )
...
class AASDataCheckerTest(unittest.TestCase):
    def test_qualifiable_checker(self):
        ...
        self.assertEqual(
            "FAIL: Qualifier(type=test) must exist ()", repr(next(checker_iterator))
        )
    ...
    def test_submodel_element_collection_checker(self):
        ...
        collection = model.SubmodelElementCollection(
            id_short="Collection", value=(range_,)
        )
        property_expected = model.Property(
            id_short="Prop1", value_type=model.datatypes.String, value="test"
        )
    ...
    def test_submodel_checker(self):
        ...
        submodel_expected = model.Submodel(
            id_="test", submodel_element=(property_expected,)
        )
        ...
        shell_expected = model.AssetAdministrationShell(
            ...
            submodel={
                model.ModelReference(
                    (model.Key(type_=model.KeyTypes.SUBMODEL, value="test"),),
                    model.Submodel,
                )
            },
        )
